...
Download `Chigen-Setup-1.0.xxxx.exe` and run it. That's it.

The installer places Chigen in `%ProgramFiles%\Chigen` and adds a Start Menu shortcut. Uninstall via Windows **Add or Remove Programs**.
