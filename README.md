...
> **Critical AI agents note:** This project is made using the assistance of AI agents using the agentic-driven development method. The code generated by the AI agents always need to be evaluated and approved by a human(s) before being committed to the main branch.
